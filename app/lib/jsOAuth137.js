            ...
            this.request = function (options) {
                ...
                withFile = (function(){
                    ...
                    for(var name in data) {
                        ...
                        if( typeof data[name].fileName != 'undefined') hasFile = true;  // added by rapodor
                    }
                ...
                xhr = Request();
                // xhr.onreadystatechange = function () { // comment out by rapodor
                xhr.onload = function(){  // added by rapodor
                  // Ti.API.info("=====onreadystatechange invoked with "+xhr.readyState+ ", ReadyStatePayload: "+ xhr.ReadyStatePayload);
                    if (xhr.readyState === 4) {
                        var regex = /^(.*?):\s*(.*?)\r?$/mg,
